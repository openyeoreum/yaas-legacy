...
from agent.a2_Solution.a22_Operation.a224_GetProcessData import GetProject, GetPromptFrame
from agent.a2_Solution.a22_Operation.a225_LoadLLM import OpenAI_LLMresponse, ANTHROPIC_LLMresponse
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2611_DataFrameCommit import FindDataframeFilePaths, LoadOutputMemory, SaveOutputMemory, AddExistedWMWMDefineToDB, AddWMWMDefineChunksToDB, WMWMDefineCountLoad, UpdatedWMWMDefine, WMWMDefineCompletionUpdate
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2612_DataSetCommit import AddExistedDataSetToDB, AddProjectContextToDB, AddProjectRawDatasetToDB, AddProjectFeedbackDataSetsToDB
...
def WMWMDefineFilter(MemoTag, responseData, memoryNote):
...
def WMWMDefineProcess(projectName, email, DataFramePath, Process = "WMWMDefine", memoryLength = 2, MessagesReview = "on", Mode = "Memory", MainLang = "ko"):
    ...
    while TotalCount < len(InputList):
        ...
        if "Continue" in InputDic:
            ...
            memoryNote = " - 이어서 작업할 데이터 (갯수만큼만 딱 맞게 작성): " + ', '.join(['[' + tag + ']' for tag in MemoTag]) + ' -\n'
            outputEnder = f"{{'핵심문구"
            ...
            Filter = WMWMDefineFilter(MemoTag, responseData, memoryNote)
