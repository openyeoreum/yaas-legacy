...
from backend.b2_Solution.b24_CoreDataFrame.b241_DataCommit.b2412_DataFrameCommit import AddExistedSummaryBodyFrameToDB, AddSummaryBodyFrameBodyToDB, SummaryBodyFrameCountLoad, SummaryBodyFrameCompletionUpdate
...
def SummaryBodyFrameUpdate(projectName, email, MessagesReview = 'off', Mode = "Memory", ExistedDataFrame = None, ExistedDataSet = None):
    ...
    if Completion == "No":
        ...
        if ExistedDataFrame != None:
            ...
            print(f"[ User: {email} | Project: {projectName} | 06_SummaryBodyFrameUpdate 완료 ]\n")
        
    else:
        print(f"[ User: {email} | Project: {projectName} | 06_SummaryBodyFrameUpdate는 이미 완료됨 ]\n")
