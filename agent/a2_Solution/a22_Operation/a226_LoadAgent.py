...
class LoadAgent:
    ...
    def _UpdateProcessDataFrame(self, InputCount, Response):
        ...
        SolutionProcessDataFrame[1].append(self._UpdateSolutionProcessDataGlobal(SolutionProcessData))
    ...
    def _UpdateSolutionProcessDataGlobal(self, SolutionProcessData):
