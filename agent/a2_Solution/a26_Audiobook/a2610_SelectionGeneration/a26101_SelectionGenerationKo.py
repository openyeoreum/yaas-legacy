...
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2611_DataFrameCommit import FindDataframeFilePaths, AddExistedSelectionGenerationKoToDB, AddSelectionGenerationKoBookContextToDB, AddSelectionGenerationKoSplitedIndexsToDB, SelectionGenerationKoCountLoad, UpdatedSelectionGenerationKo, SelectionGenerationKoCompletionUpdate
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2612_DataSetCommit import AddExistedDataSetToDB

#############################################
##### a26101_SelectionGenerationKo 생성 #####
#############################################
## BodyFrameBodys 로드
    ...
    for i in range(len(SelectionGenerationKoSplitedIndexs)):
        ...
        for j in range(len(SelectionGenerationKoSplitedBodys)):
            ...
            for chunkid in ChunkIds:
                ...
                NarratorCharacter = Narrater['MainCharacterList'][0]['MainCharacter']

                Voice = {'Character': NarratorCharacter, 'CharacterTag': Narrater['CharacterTag'], 'Language': Language, 'Gender': Narrater['Gender'], 'Age': Narrater['Age'], 'Emotion': emotions[0]}
...
def SelectionGenerationKoUpdate(projectName, email, ExistedDataFrame = None):
    ...
    if Completion == "No":
        ...
        if ExistedDataFrame != None:
            ...
            DataFrame = AddSelectionGenerationKoBookContextToDB(DataFrame, SelectionGenerationKoBookContext)
