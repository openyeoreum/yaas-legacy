...
from backend.b2_Solution.b21_General.b218_ProjectCommit import GetProjectDataPath, LoadJsonFrame
...
def InitBookPreprocess(projectName, email):
    ...
    with get_db() as db:
        ...
        project.BookPreprocessFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-00_BookPreprocessFrame.json")[1]
...
def InitIndexFrame(projectName, email):
    ...
    with get_db() as db:
        ...
        project.IndexFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-01_IndexFrame.json")[1]
...
def InitDuplicationPreprocess(projectName, email):
    ...
    with get_db() as db:
        ...
        project.DuplicationPreprocessFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-02_DuplicationPreprocessFrame.json")[1]
...
def InitPronunciationPreprocess(projectName, email):
    ...
    with get_db() as db:
        ...
        project.PronunciationPreprocessFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-03_PronunciationPreprocessFrame.json")[1]
...
def InitBodyFrame(projectName, email):
    ...
    with get_db() as db:
        ...
        project.BodyFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-04_BodyFrame.json")[1]
        project.BodyFrame[2] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-04_BodyFrame.json")[2]
...
def InitHalfBodyFrame(projectName, email):
    ...
    with get_db() as db:
        ...
        project.HalfBodyFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-04_BodyFrame.json")[1]
        project.HalfBodyFrame[2] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-04_BodyFrame.json")[2]
...
def InitCaptionCompletion(projectName, email):
    ...
    with get_db() as db:
        ...
        project.CaptionFrame[1] = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-05_CaptionFrame.json")[1]
...
def InitContextDefine(projectName, email):
    ...
    with get_db() as db:
        ...
        project.ContextDefine[1] = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-01_ContextDefine.json")[1]
...
def InitContextCompletion(projectName, email):
    ...
    with get_db() as db:
        ...
        project.ContextCompletion[1] = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-02_ContextCompletion.json")[1]
        project.ContextCompletion[2] = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-02_ContextCompletion.json")[2]
...
def InitWMWMDefine(projectName, email):
    ...
    with get_db() as db:
        ...
        project.WMWMDefine[1] = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-03_WMWMDefine.json")[1]
        project.WMWMDefine[2] = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-03_WMWMDefine.json")[2]
...
def InitWMWMMatching(projectName, email):
    ...
    with get_db() as db:
        ...
        project.WMWMMatching[1] = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-04_WMWMMatching.json")[1]
...
def InitCharacterDefine(projectName, email):
    ...
    with get_db() as db:
        ...
        project.CharacterDefine[1] = LoadJsonFrame(ProjectDataPath + "/b5343_Character/b5343-01_CharacterDefine.json")[1]
...
def InitCharacterCompletion(projectName, email):
    ...
    with get_db() as db:
        ...
        project.CharacterCompletion[1] = LoadJsonFrame(ProjectDataPath + "/b5343_Character/b5343-02_CharacterCompletion.json")[1]
        project.CharacterCompletion[2] = LoadJsonFrame(ProjectDataPath + "/b5343_Character/b5343-02_CharacterCompletion.json")[2]
...
def InitSoundMatching(projectName, email):
    ...
    with get_db() as db:
        ...
        project.SoundMatching[1] = LoadJsonFrame(ProjectDataPath + "/b5345_Sound/b5345-01_SoundMatching.json")[1]
...
def InitSFXMatching(projectName, email):
    ...
    with get_db() as db:
        ...
        project.SFXMatching[1] = LoadJsonFrame(ProjectDataPath + "/b5346_SFX/b5346-01_SFXMatching.json")[1]
...
def InitCorrectionKo(projectName, email):
    ...
    with get_db() as db:
        ...
        project.CorrectionKo[1] = LoadJsonFrame(ProjectDataPath + "/b5348_Correction/b5348-01_CorrectionKo.json")[1]
...
def InitSelectionGenerationKo(projectName, email):
    ...
    with get_db() as db:
        ...
        project.SelectionGenerationKo[1] = LoadJsonFrame(ProjectDataPath + "/b5349_SelectionGeneration/b5349-01_SelectionGenerationKo.json")[1]
