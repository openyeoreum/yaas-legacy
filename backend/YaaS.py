...
if __name__ == "__main__":
    ...
    ## ScriptGen ##
    # 디폴트: {"ScriptGen": "off", "RawMode": "on", "Process": "", "MainKey": "", "KeyList": []}
    # 우리반시집: {"ScriptGen": "on", "RawMode": "on", "Process": "SejongCityOfficeOfEducation_Poem", "MainKey": "단락", "KeyList": ["선생님의 소개", "아이가 작성한 시", "선생님의 칭찬"]}
    # 빼기명상을통한나의변화: {"ScriptGen": "on", "RawMode": "on", "Process": "ChangesAfterMeditation_Script", "MainKey": "글내용", "KeyList": ["목차", "내용"]}

    projectNameList = ['241118_세종교육청우리반오디오북테스트']
    ScriptGen = {"ScriptGen": "on", "RawMode": "on", "Process": "SejongCityOfficeOfEducation_Poem", "MainKey": "단락", "KeyList": ["선생님의 소개", "아이가 작성한 시", "선생님의 칭찬"]} # 'Gen' : 'on', 'off' : on 은 스크립트 생성으로 시작, off 는 스트립트 생성 필요없음 / 'RawMode' : 'on', 'off' : on 은 _Index(Raw).txt 및 _Body(Raw).txt 생성, off 는 _Index.txt 및 _Body.txt 생성 / 'Process' : 'SejongCityOfficeOfEducation_Poem' ... / 'MainKey', 'KeyList' : '메인키': ['프롬프트 결과로', '나오는 KeyList', '작성']
