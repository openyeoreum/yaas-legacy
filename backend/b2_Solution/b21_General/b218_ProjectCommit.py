...
def GetProjectDataPath():
    RootPath = "/yaas"
    DataPath = "backend/b5_Database/b53_ProjectData/b534_AudioBookProject"
...
def AddProjectToDB(projectName, email):
    with get_db() as db:
        ...
        bookPreprocessFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-00_BookPreprocessFrame.json")
        indexFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-01_IndexFrame.json")
        duplicationPreprocessFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-02_DuplicationPreprocessFrame.json")
        pronunciationPreprocessFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-03_PronunciationPreprocessFrame.json")
        bodyFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-04_BodyFrame.json")
        halfBodyFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-04_BodyFrame.json")
        captionFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-05_CaptionFrame.json")
        phargraphTransitionFrame = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-06_PhargraphTransitionFrame.json")
        bodyContextTags = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-07_BodyContextTags.json")
        wMWMContextTags = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-08_WMWMContextTags.json")
        characterContextTags = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-09_CharacterContextTags.json")
        soundContextTags = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-10_SoundContextTags.json")
        sFXContextTags = LoadJsonFrame(ProjectDataPath + "/b5341_Script/b5341-11_SFXContextTags.json")
        contextDefine = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-01_ContextDefine.json")
        contextCompletion = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-02_ContextCompletion.json")
        wMWMDefine = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-03_WMWMDefine.json")
        wMWMMatching = LoadJsonFrame(ProjectDataPath + "/b5342_Context/b5342-04_WMWMMatching.json")
        characterDefine = LoadJsonFrame(ProjectDataPath + "/b5343_Character/b5343-01_CharacterDefine.json")
        characterCompletion = LoadJsonFrame(ProjectDataPath + "/b5343_Character/b5343-02_CharacterCompletion.json")
        soundMatching = LoadJsonFrame(ProjectDataPath + "/b5345_Sound/b5345-01_SoundMatching.json")
        sFXMatching = LoadJsonFrame(ProjectDataPath + "/b5346_SFX/b5346-01_SFXMatching.json")
        translationKo = LoadJsonFrame(ProjectDataPath + "/b5347_Translation/b5347-01_TranslationKo.json")
        translationEn = LoadJsonFrame(ProjectDataPath + "/b5347_Translation/b5347-02_TranslationEn.json")
        correctionKo = LoadJsonFrame(ProjectDataPath + "/b5348_Correction/b5348-01_CorrectionKo.json")
        correctionEn = LoadJsonFrame(ProjectDataPath + "/b5348_Correction/b5348-02_CorrectionEn.json")
        selectionGenerationKo = LoadJsonFrame(ProjectDataPath + "/b5349_SelectionGeneration/b5349-01_SelectionGenerationKo.json")
        mixingMasteringKo = LoadJsonFrame(ProjectDataPath + "/b53410_MixingMastering/b53410-01_MixingMasteringKo.json")
        ### 아래로 추가되는 데이터프레임 작성 ###
