...
if __name__ == "__main__":
    ...
    ## ScriptGen ##
    ## {"ScriptGen": "off", "RawMode": "on", "Process": "", "MainKey": "", "KeyList": []}, 우리반시집: {"ScriptGen": "on", "RawMode": "on", "Process": "SejongCityOfficeOfEducation_Poem", "MainKey": "단락", "KeyList": ["선생님의 소개", "아이가 작성한 시", "선생님의 칭찬"]}, 빼기명상을통한나의변화: {"ScriptGen": "on", "RawMode": "on", "Process": "ChangesAfterMeditation_Script", "MainKey": "글내용", "KeyList": ["목차", "내용"]} '241122_김현아', '241122_이향선', '241122_이상초'

    projectNameList = ['241122_이상초']
    ScriptGen = {"ScriptGen": "on", "RawMode": "off", "Process": "ChangesAfterMeditation_Script", "MainKey": "글내용", "KeyList": ["목차", "내용"]} # 'Gen' : 'on', 'off' : on 은 스크립트 생성으로 시작, off 는 스트립트 생성 필요없음 / 'Process' : 'SejongCityOfficeOfEducation_Poem' ... / 'KeyList' : ['프롬프트 결과로', '나오는 KeyList', '작성']
