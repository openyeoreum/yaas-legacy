...
from backend.b2_Solution.b24_DataFrame.b241_ScriptGen.b2411_ScriptGenUpdate import ScriptGenUpdate, ScriptGenResponseJson
...
def SolutionDataFrameUpdate(email, projectName, indexMode = "Define", messagesReview = "on", bookGenre = "Auto", Translations = []):
    ...
    RawDataSetPath = f"/yaas/storage/s1_Yeoreum/s12_UserStorage/yeoreum_user/yeoreum_storage/{projectName}/{projectName}_dataset_file/"
