...
def CharacterCompletionUpdate(projectName, email, MessagesReview = 'off', Mode = "Memory", ExistedDataFrame = None, ExistedDataSet = None):
    print(f"< User: {email} | Project: {projectName} | 07_CharacterCompletionUpdate 시작 >")
    ...
    if Completion == "No":
        ...
        if ExistedDataFrame != None:
            ...
            print(f"[ User: {email} | Project: {projectName} | 07_CharacterCompletionUpdate는 ExistedCharacterCompletion으로 대처됨 ]\n")
        else:
            ...
            print(f"[ User: {email} | Project: {projectName} | 07_CharacterCompletionUpdate 완료 ]\n")
        
    else:
        print(f"[ User: {email} | Project: {projectName} | 07_CharacterCompletionUpdate는 이미 완료됨 ]\n")
