...
from extension.e1_Solution.e13_ExtensionDataFrame.e131_ExtensionDataCommit.e1311_ExtensionDataFrameCommit import AddExistedLifeGraphTranslationEnToDB, AddLifeGraphTranslationEnLifeGraphsToDB, AddLifeGraphTranslationEnLifeDataTextsToDB, LifeGraphTranslationEnCountLoad, InitLifeGraphTranslationEn, LifeGraphTranslationEnCompletionUpdate, UpdatedLifeGraphTranslationEn
...
def LifeGraphTranslationEnProcess(lifeGraphSetName, latestUpdateDate, Process = "LifeGraphTranslationEn", memoryLength = 2, MessagesReview = "on", Mode = "Memory"):
    ...
    while TotalCount < len(InputList):
        ...
        # ########## 테스트 후 삭제 ##########
        # LifeGraphFramePath = "/yaas/extension/e4_Database/e41_DatabaseFeedback/e411_LifeGraphData/23120601_CourseraMeditation_03_outputMemoryDics_231210.json"
...
def LifeGraphTranslationEnResponseJson(lifeGraphSetName, latestUpdateDate, messagesReview = 'off', mode = "Memory"):
    lifeGraph = GetLifeGraph(lifeGraphSetName, latestUpdateDate)
    LifeGraphs = lifeGraph.LifeGraphFrame[1]['LifeGraphs'][1:]
    outputMemoryDics = LifeGraphTranslationEnProcess(lifeGraphSetName, latestUpdateDate, MessagesReview = messagesReview, Mode = mode)
...
def LifeGraphTranslationEnUpdate(lifeGraphSetName, latestUpdateDate, MessagesReview = 'off', Mode = "Memory", ExistedDataFrame = None):
    ...
    if Completion == "No":
        ...
        if ExistedDataFrame != None:
            ...
            responseJson = LifeGraphTranslationEnResponseJson(lifeGraphSetName, latestUpdateDate, messagesReview = MessagesReview, mode = Mode)
