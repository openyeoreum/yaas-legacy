...
def BestSellerContextDefineProcess(TotalBookDataPath, projectName, email, Process1 = "BestSellerContextDefine", Process2 = "BestSellerCommentAnalysis", MessagesReview = "on", mode = "Master"):
    ...
    TempTotalBookDataPath = f"/yaas/storage/s1_Yeoreum/s15_DataCollectionStorage/s152_TrendData/s1522_BookData/s15221_TotalBookData/TempTotalBookData/{Date}_TempTotalBookData.json"
    StartPoint = 0
    InContext = True
