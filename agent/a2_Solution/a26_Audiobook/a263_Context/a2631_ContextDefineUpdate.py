...
from agent.a2_Solution.a22_Operation.a224_GetProcessData import GetProject, SaveProject, GetPromptFrame
from agent.a2_Solution.a22_Operation.a225_LoadLLM import OpenAI_LLMresponse, ANTHROPIC_LLMresponse
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2611_DataFrameCommit import FindDataframeFilePaths, LoadOutputMemory, SaveOutputMemory, AddExistedContextDefineToDB, AddContextDefineChunksToDB, ContextDefineCountLoad, UpdatedContextDefine, ContextDefineCompletionUpdate
...
def ContextDefineProcess(projectName, email, DataFramePath, Process = "ContextDefine", memoryLength = 2, MessagesReview = "on", Mode = "Memory", MainLang = "ko"):
