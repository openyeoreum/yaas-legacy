...
if __name__ == "__main__":
    ...
    Translation = "Auto" # 'Auto', 'Auto', 'En', 'Ja', 'Zh', 'Es' ... 중 원문언어를 선택
    TextBook = "" # '', 'ONDOBook', 'ONDOMeditation', 'ONDOArchitect', 'LifeGraphAnalysis' ... 중 텍스트북 제작 템플릿을 다중 선택
    AudioBook = "미정(낭독)" # '', 'Auto', '클로닝성우이름', '성우이름(특성)' ... 중 선택
