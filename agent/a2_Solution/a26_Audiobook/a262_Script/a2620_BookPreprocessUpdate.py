...
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2611_DataFrameCommit import FindDataframeFilePaths, LoadOutputMemory, SaveOutputMemory, AddExistedBookPreprocessToDB, AddBookPreprocessBookPagesToDB, BookPreprocessCountLoad, UpdatedBookPreprocess, BookPreprocessCompletionUpdate
...
def BookPreprocessProcess(projectName, email, DataFramePath, Process = "BookPreprocess", memoryLength = 2, MessagesReview = "on", Mode = "Memory", MainLang = "ko"):
