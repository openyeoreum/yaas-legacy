...
from agent.a2_Solution.a22_Operation.a224_GetProcessData import GetProject, SaveProject, GetSoundDataSet
from agent.a4_Generation.a43_AudioBook.a433_TypeCastWebMacro import TypeCastMacro
from agent.a4_Generation.a43_AudioBook.a434_VoiceSplit import VoiceSplit
    ...
    for GenerationKoChunks in SelectionGenerationKoChunks:
        ...
        for Actor in MatchedActors:
            try:
                ...
                sys.exit(f"[ a572-01_VoiceDataSet에 낭독할 성우가 부족함, 아래 경로의 ActorsNeededFileName을 보고 성우를 생성해주세요. ]\n{ActorsNeededFilePath}")
...
def CloneVoiceSetting(projectName, Narrator, CloneVoiceName, MatchedActors, CloneVoiceActorPath, SelectionGenerationKoChunks):
    ...
    ## Narrator가 "VoiceActor" 이면서 성우가 지정된 경우 CloneVoiceDic 생성 ##
        ...
        # VoiceDataSetPath 로드
        VoiceDataSetPath = "/yaas/agent/a5_Database/a57_RelationalDatabase/a572_Character/a572-01_VoiceDataSet.json"
        ...
        for _Matched in MatchedActors:
            if _Matched['CharacterTag'] == 'Narrator':
                ...
                try:
                    ...
                    sys.exit(f'[ (({CloneVoiceName})) a572-01_VoiceDataSet에 성우가 존재하지 않음 ]\n/yaas/agent/a5_Database/a57_RelationalDatabase/a572_Character/a572-01_VoiceDataSet.json')
                try:
                    _Matched['ActorName'] = AfterNarratorName
                except UnboundLocalError:
                    sys.exit(f'[ (({CloneVoiceName})) a572-01_VoiceDataSet에 성우가 존재하지 않음 ]\n/yaas/agent/a5_Database/a57_RelationalDatabase/a572_Character/a572-01_VoiceDataSet.json')
            ...
            if _Matched['CharacterTag'] == 'SecondaryNarrator':
                if MatchedSecondaryVoiceActor != 'None':
                    ...
                    try:
                        ...
                        sys.exit(f'[ (({CloneVoiceName}의 SecondaryVoice인 {MatchedSecondaryVoiceActor["Name"]})) a572-01_VoiceDataSet에 성우가 존재하지 않음 ]\n/yaas/agent/a5_Database/a57_RelationalDatabase/a572_Character/a572-01_VoiceDataSet.json')
                    try:
