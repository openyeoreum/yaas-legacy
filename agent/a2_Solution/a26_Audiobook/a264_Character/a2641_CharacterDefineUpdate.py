...
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2611_DataFrameCommit import FindDataframeFilePaths, LoadOutputMemory, SaveOutputMemory, AddExistedCharacterDefineToDB, AddCharacterDefineChunksToDB, CharacterDefineCountLoad, UpdatedCharacterDefine, CharacterDefineCompletionUpdate
...
def CharacterDefineProcess(projectName, email, DataFramePath, Process = "CharacterDefine", memoryLength = 2, MessagesReview = "on", Mode = "Memory", MainLang = "ko"):
