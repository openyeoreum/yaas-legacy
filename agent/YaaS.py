...
from agent.a4_Core.a43_Run.a431_GeneralUpdate import AccountUpdate, SolutionProjectUpdate
from agent.a4_Core.a43_Run.a432_EstimateUpdate import SolutionEstimateUpdate
from agent.a4_Core.a43_Run.a433_DataCollectionUpdate import SolutionDataCollectionUpsert, SolutionDataCollectionSearch
from agent.a4_Core.a43_Run.a434_ScriptUpdate import SolutionScriptUpdate
from agent.a4_Core.a43_Run.a435_TranslationUpdate import SolutionTranslationUpdate
from agent.a4_Core.a43_Run.a436_DataFrameUpdate import SolutionDataFrameUpdate
from agent.a4_Core.a43_Run.a439_AudioBookUpdate import CreationAudioBookUpdate
...
def YaaSCore(email, ProjectName, MainLang, Estimate, DataCollection, Search, Script, Translation, TextBook, AudioBook, Marketing, MessagesReview, Account):
...
if __name__ == "__main__":
    ...
    ## ProjectNameList ##
    # '250101_스튜디오여름'
    # '240223_나는외식창업에적합한사람인가', '240223_나무에서만난경영지혜', '240223_노인을위한나라는있다', '240223_마케터의무기들', '240405_빌리월터스겜블러', '240412_카이스트명상수업', '240705_도산안창호', '240801_빨간풍차가있는집', '240802_암을이기는천연항암제', '240919_암을이기는천연항암제요약', '240812_룰루레몬스토리', '240815_노유파', '240908_나무스토리텔링', '240910_AI미래시나리오2030', '240925_불멸의지혜', '241005_그해여름필립로커웨이에서일어난소설같은일', '241009_책갈피와책수레', '241010_틈틈이낭만', '241024_오성삼유튜브', '241024_서울장애인가족지원센터당선작13선', '241029_누가정부창업지원을받는가', '241116_베이버터와다섯개의빛', '241118_세종교육청우리반오디오북새움중1학년8반', '241118_세종교육청우리반오디오북아름초5학년5반', '241118_세종교육청우리반오디오북아름초1학년1반', '241127_엄마의첫공부', '241128_끌리는이들에겐이유가있다', '241204_개정교육과정초등교과별이해연수', '241210_공부하듯주식해서보화찾기요약', '241210_끌리는이들에겐이유가있다요약', '241210_나는외식창업에적합한사람인가요약', '241226_법이사라진내멋대로마을을지켜줘', '250111_프로스트와베타', '250201_멘진', '250202_정년그깊은독백', '250225_격몽', '250213_요한복음삼장', '250221_킹제임스성경의역사', '250221_성경샘플', '250221_지식정보인프라96호', '250226_생각하는대로그렇게된다', '250304_데미안', '250309_방법서설', '250312_모방의법칙', '250320_언캐니한것들의목소리', '250322_에밀', '250323_돈버는법', '250414_삶의혼란너머에서', '250418_싯다르타', '250424_카다인사이드사십일호', '250511_생명이란무엇인가', '250515_정신과물질', '250517_기억과숲다섯번째', '250519_기억과숲여섯번째', '250527_꼭알아야할생명과학샘플', '250530_바람에마음을맡기다', '250613_수되수', '250616_모든것은마음에서', '250707_말하는대로그렇게된다', '250728_나미부부의그리스신화속꽃스토리텔링', '250730_엑셀인베스트먼트', '250826_차의과학대학교수시모집안내가이드','250901_생각하는대로그렇게된다확장판', '250911_오늘도불안한엄마들에게', '250917_기억과숲일곱번째', '250928_메가스터디', '251001_지극히사적인이탈리아', '251014_오늘지금', '251014_생각의힘', '251016_절대목표', '251019_지극히사적인일본', '251020_러시아의문장들', '251020_사랑이라고쓰고나니', '251020_지극히사적인네팔', '251020_지극히사적인영국', '251020_지극히사적인이탈리아', '251020_지극히사적인프랑스', '251024_비전문학회', '251028_하루이십사시간을사는방법', '251113_주의력의시대', '251118_여름밤해변의무무씨', '251121_예미오디오북', '251124_물리력의시대', '251208_따뜻한말이시작이되어', '251211_당신을품는다는건', '251217_다개국어프로젝트'

    Email = "yeoreum00128@gmail.com"
    ProjectName = "260425_지극히사적인일본"
    MainLang = "Ko" # 'Ko', 'En', 'Ja', 'Zh', 'Es' ... 중 메인이 되는 언어를 선택 ((번역 후) 결과물의 언어)
    ...
    AudioBook = "이준영(낭독)" # '', 'Auto', '클로닝성우이름', '성우이름(특성)' ... 중 선택
    ...
    YaaSCore(Email, ProjectName, MainLang, Estimate, DataCollection, Search, Script, Translation, TextBook, AudioBook, Marketing, MessagesReview, Account)