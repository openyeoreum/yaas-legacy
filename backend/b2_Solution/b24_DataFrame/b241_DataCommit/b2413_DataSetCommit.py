...
if __name__ == "__main__":
    ...
    # with open(RawDataSetPath + "yeoreum00128@gmail.com_231022_우리는행복을진단한다_09_CharacterDefineDataSet.json", 'r', encoding='utf-8') as file:
    #     processDataset = json.load(file)
    # processDataset = OutputAccuracy(projectName, email, process, processDataset)
    
    # with open(RawDataSetPath + "yeoreum00128@gmail.com_231022_우리는행복을진단한다_09_CharacterDefineDataSet_Accuracy.json", 'w', encoding='utf-8') as file:
