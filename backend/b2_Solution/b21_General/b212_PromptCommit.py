...
def AddPromptToDB():
    with get_db() as db:
        ...
        bodyToneEditing = LoadJsonFrame(PromptDataPath + "/b543_TranslationPrompt/b543-08_BodyToneEditing.json")
        bodyLanguageEditing = LoadJsonFrame(PromptDataPath + "/b543_TranslationPrompt/b543-08_BodyLanguageEditing.json")
