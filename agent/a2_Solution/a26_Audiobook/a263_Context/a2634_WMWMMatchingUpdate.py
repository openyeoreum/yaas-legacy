...
from agent.a2_Solution.a26_Audiobook.a261_DataCommit.a2611_DataFrameCommit import FindDataframeFilePaths, LoadOutputMemory, SaveOutputMemory, AddExistedWMWMMatchingToDB, AddWMWMMatchingChunksToDB, AddWMWMMatchingBODYsToDB, AddWMWMMatchingIndexsToDB, AddWMWMMatchingBookToDB, WMWMMatchingCountLoad, UpdatedWMWMMatching, WMWMMatchingCompletionUpdate
    ...
    if Completion == "No":
        ...
        if ExistedDataFrame != None:
            ...
            for Update in UpdateTQDM:
                ...
                DataFrame = AddWMWMMatchingBookToDB(DataFrame, BookId, Title, Phrases, Vector, WMWM)
                # i값 수동 업데이트
                i += 1
            
            UpdateTQDM.close()
            # Completion "Yes" 업데이트
            WMWMMatchingCompletionUpdate(projectName, email, DataFrame)
