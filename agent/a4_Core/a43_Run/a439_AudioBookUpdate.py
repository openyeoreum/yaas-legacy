...
from agent.a6_Generation.a63_AudioBook.a632_VoiceLayerSplitGenerator import VoiceLayerUpdate
from agent.a6_Generation.a63_AudioBook.a635_MusicLayerSelector import MusicLayerUpdate
...
if __name__ == "__main__":
    ...
    CreationAudioBookUpdate(projectName, email, genLang, narrator, cloneVoiceName, readingStyle, voiceReverbe, mainLang, macro = macro, bracket = bracket, volumeEqual = volumeEqual, account = account, voiceEnhance = voiceEnhance, voiceFileGen = voiceFileGen, messagesReview = messagesReview)
